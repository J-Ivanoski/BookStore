...
public class BasicController {
  ...
  @RequestMapping(value = {"/deliveryPackage"}, method = RequestMethod.GET)
  public String deliveryPackage(
          Model model
  ) {
    List<DeliveryPackage> list = (List)queryService.findDeliveryPackages();

    model.addAttribute("deliveryPackage", list);
